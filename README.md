...
![Minimum Spanning Tree<span data-label="fig:MST"></span>](images/mst.jpg)
...
![Fibbonaci Heap<span data-label="fig:fib1"></span>](images/Fibbonaci.JPG)
...
![Van Emde Boas Tree<span data-label="fig:vb"></span>](images/vEB.png)
...
![Comparison with random edge weights<span data-label="fig:vb"></span>](images/random_data.png)
...
![Comparison with sorted edge weights<span data-label="fig:vb"></span>](images/sorted_data.png)
...
![Comparison with reverse sorted edge weights<span data-label="fig:vb"></span>](images/rsorted_data.png)
